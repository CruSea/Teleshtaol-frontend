...
import {ArticlesModule} from "./views/components/articles.module";
...
import {RegisterModule} from "./views/login/register/register.module";
import {RegisterRoutingModule} from "./views/login/register/register-routing.module";
